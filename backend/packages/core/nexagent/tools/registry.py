...
_BUILTIN_SPECS: dict[str, ToolSpec] = {
    ...
    "list_wiki_pages": ToolSpec(
        ...
        description="List pages in an enabled Wiki knowledge base with filters.",
        category="knowledge",
    ...
    "read_wiki_page": ToolSpec(
        name="read_wiki_page",
        description="Read a page body and metadata from an enabled Wiki knowledge base.",
        category="knowledge",
        module="nexagent.tools.builtin.wiki",
    ...
    "wiki_lint": ToolSpec(
        name="wiki_lint",
        description="Inspect health issues for an enabled Wiki knowledge base.",
        category="knowledge",
        module="nexagent.tools.builtin.wiki",
    ...
    "get_wiki_graph": ToolSpec(
        name="get_wiki_graph",
        description="Summarize the relationship graph of an enabled Wiki knowledge base.",
        category="knowledge",
        module="nexagent.tools.builtin.wiki",
    ...
    "compile_wiki": ToolSpec(
        name="compile_wiki",
        description="Compile uploaded source files into an enabled Wiki knowledge base after explicit confirmation.",
        category="knowledge",
        module="nexagent.tools.builtin.wiki",
